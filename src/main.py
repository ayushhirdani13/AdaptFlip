...
def parse_args():
    ...
    parser.add_argument("--top_k",
        ...
        nargs='+',
        default=[3, 10],
        help="compute metrics@top_k, default: [3, 10]")
...
if __name__ == "__main__":
    ...
    OUTPUT_SAVE_DIR += f'/{args.batch_mode}/{args.batch_by}/{args.model}_{args.W}_{args.alpha}_{args.batch_size}_{args.num_ng}@{args.best_k}'
    os.makedirs(MODEL_DIR, exist_ok=True)
    os.makedirs(RESULT_DIR, exist_ok=True)
    os.makedirs(OUTPUT_SAVE_DIR, exist_ok=True)

    MODEL_FILE = f"{args.model}_{args.W}_{args.alpha}_{args.batch_size}_{args.num_ng}@{args.best_k}.pth"
